...
# Module-level shortcuts for backward compatibility
...
VM2_API_URL = Config.OGS_COLLECTOR_URL
DOWNLOAD_DIR = Config.OGS_DOWNLOAD_DIR
PROCESSED_FILES_LOG = Config.OGS_DOWNLOAD_DIR + "/.processed_files.txt"
POLL_INTERVAL = Config.OGS_PROCESS_INTERVAL
