...
class DatabaseManager:
    ...
    def connect(self):
        ...
        try:
            ...
            if self.connection.is_connected():
                ...
                logger.info(
                    "✓ Connected to MySQL Server version %s", db_info
                )
    ...
    def insert_controller_sync(
        self, local_site, remote_site, timestamp_str, log_file
    ):
        ...
        try:
            ...
            cursor.execute(query, (local_site, remote_site, timestamp,
                                   log_file))
            self.connection.commit()
            cursor.close()
            return True
