...
class OGSProcessor(BaseProcessor):
    ...
    def fetch_latest_package(self):
        ...
        try:
            ...
            self.logger.error("Error fetching package: {e}")
            return None
    ...
    def insert_environment(self, data):
        ...
        try:
            ...
            self.logger.error("Error inserting environment: {e}")
            return False
    ...
    def insert_link(self, data):
        ...
        try:
            ...
            self.logger.error("Error inserting link: {e}")
            return False
    ...
    def insert_summary(self, data):
        ...
        try:
            ...
            self.logger.error("Error inserting summary: {e}")
            return False
    ...
    def insert_alerts(self, alerts):
        ...
        for alert in alerts:
            try:
                ...
                self.logger.error("Error inserting alert: {e}")
    ...
    def process_data(self):
        ...
        if success:
            ...
            self.logger.info("✓ Package processed: {package_id}")
        else:
            self.stats["failed"] += 1
            self.logger.error("✗ Failed to process package: {package_id}")
    ...
    def run(self):
        ...
        self.logger.info("Remote Collector: {self.config.OGS_COLLECTOR_URL}")
        self.logger.info("Process Interval: {self.config.OGS_PROCESS_INTERVAL}s")
        self.logger.info("="*60)
        ...
        while self.running:
            try:
                ...
                self.logger.error("Error in main loop: {e}", exc_info=True)
                time.sleep(self.config.OGS_PROCESS_INTERVAL)
