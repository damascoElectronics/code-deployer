...
This module handles parsing log files and extracting
structured data for storage in the database.
"""
...
class LogParser:
    ...
    def _parse_key_creation(self, line, entry):
        """Parse key creation specific fields.

        Args:
            line (str): Log line to parse.
            entry (dict): Dictionary to update with parsed values.
        """
    ...
    def _parse_sync_latency(self, line, entry):
        """Parse sync latency specific fields.
    ...
    def _parse_key_count(self, line, entry):
        """Parse key count specific fields.
    ...
    def _parse_controller_sync(self, line, entry):
        """Parse controller sync specific fields.
    ...
    def process_log_file(self, filepath):
        ...
        Args:
            filepath (str): Path to the log file to process.
        ...
        try:
            ...
            with open(filepath, 'r', encoding='utf-8') as file:
                for line in file:
                    ...
                    if success:
                        self._update_stats(stats, entry)
    ...
    def _update_stats(self, stats, entry):
    ...
    def _store_entry(self, entry, filename):
        ...
        Args:
            entry (dict): Parsed log entry.
            filename (str): Source log filename.
